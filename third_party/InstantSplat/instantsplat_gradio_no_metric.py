...
def process_scene(input_dir, output_dir, n_views, iterations, scene_graph, progress=gr.Progress()):
...
with gr.Blocks() as demo:
    ...
    process_btn.click(fn=process_scene, inputs=[input_dir, output_dir, n_views, iterations, scene_graph], outputs=output_video)
